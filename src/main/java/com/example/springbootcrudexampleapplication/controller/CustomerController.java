package com.example.springbootcrudexampleapplication.controller;

import com.example.springbootcrudexampleapplication.entity.Customer;
import com.example.springbootcrudexampleapplication.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<List<Customer>>addCustomer(@RequestBody  Customer customer){
        List<Customer> addCustomer=customerService.findAllCustomer();
        return new ResponseEntity<List<Customer>>(addCustomer, HttpStatus.CREATED);
    }
